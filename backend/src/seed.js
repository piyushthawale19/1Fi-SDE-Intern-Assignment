...
const products = [
  ...
  },
  {
    brand: 'Google',
    name: 'Pixel 8 Pro',
    description: 'Powered by Google Tensor G3, Pixel 8 Pro delivers pro-level cameras, 24-hour battery life, and AI-driven features like Best Take, Audio Magic Eraser, and Live Translate.',
    category: 'Smartphones',
    basePrice: 106999,
    ...
    variants: [
      { label: '128GB - Bay Blue', type: 'storage', value: '128GB - Bay Blue', priceModifier: 0 },
      { label: '256GB - Bay Blue', type: 'storage', value: '256GB - Bay Blue', priceModifier: 7000 },
      { label: '128GB - Obsidian', type: 'storage', value: '128GB - Obsidian', priceModifier: 0 },
    ],
    emiPlans: [
      { tenureMonths: 3, interestRate: 0, processingFee: 0 },
      { tenureMonths: 6, interestRate: 0, processingFee: 0 },
  ...
  },
  {
    brand: 'Dell',
    name: 'XPS 15 Laptop',
    description: 'Dell XPS 15 features a stunning 15.6-inch 3.5K OLED InfinityEdge touch display, 13th Gen Intel Core i7 processor, and NVIDIA GeForce RTX 4060 graphics.',
    category: 'Laptops',
    basePrice: 209990,
    ...
    specifications: JSON.stringify({
      ...
      'Display': '15.6-inch 3.5K OLED Touch, 400 nits',
      'RAM': '16GB / 32GB DDR5',
      'Storage': '1TB NVMe M.2 SSD',
      'Weight': '1.92 kg',
    }),
    variants: [
      { label: '16GB RAM / 1TB SSD - Platinum Silver', type: 'config', value: '16GB / 1TB', priceModifier: 0 },
      { label: '32GB RAM / 1TB SSD - Platinum Silver', type: 'config', value: '32GB / 1TB', priceModifier: 20000 },
    ],
    emiPlans: [
      { tenureMonths: 3, interestRate: 0, processingFee: 0 },
      { tenureMonths: 6, interestRate: 0, processingFee: 0 },
      { tenureMonths: 12, interestRate: 12, processingFee: 499 },
      { tenureMonths: 24, interestRate: 15, processingFee: 699 },
    ],
  },
  {
    brand: 'LG',
    name: 'C3 55-inch 4K Smart OLED TV',
    description: 'Self-lit OLED pixels deliver infinite contrast and 100% color fidelity. Powered by alpha 9 AI Processor Gen6, Dolby Vision IQ, Dolby Atmos, and 120Hz Refresh Rate for gaming.',
    category: 'Appliances',
    basePrice: 169990,
    ...
    specifications: JSON.stringify({
      'Screen Size': '55-inch OLED 4K UHD',
      'Refresh Rate': '120Hz Native',
      'Processor': 'α9 AI Processor 4K Gen6',
      'HDR': 'Dolby Vision / HDR10 / HLG',
      'Audio': '40W 2.2 Channel, Dolby Atmos',
      'Gaming': 'G-Sync, FreeSync, 4x HDMI 2.1',
    }),
    variants: [
      { label: '55-inch OLED', type: 'size', value: '55-inch', priceModifier: 0 },
      { label: '65-inch OLED', type: 'size', value: '65-inch', priceModifier: 45000 },
    ],
    emiPlans: [
      { tenureMonths: 3, interestRate: 0, processingFee: 0 },
      { tenureMonths: 6, interestRate: 0, processingFee: 0 },
      { tenureMonths: 12, interestRate: 12, processingFee: 399 },
      { tenureMonths: 18, interestRate: 14, processingFee: 499 },
    ],
  },
  {
    brand: 'Dyson',
    name: 'Airwrap Multi-Styler Complete',
    description: 'Style hair with air using the Coanda effect. Dries and styles simultaneously without extreme heat. Comes with barrels to curl or wave, and brushes to smooth and control.',
    category: 'Appliances',
    basePrice: 49900,
    ...
    specifications: JSON.stringify({
      'Motor': 'Dyson Digital Motor V9 (110,000rpm)',
      'Heat Settings': '3 precise heat settings',
      'Airflow': '3 precise speed settings',
      'Weight': '0.66 kg',
      'Cable Length': '2.68 m',
    }),
    variants: [
      { label: 'Nickel / Copper', type: 'color', value: 'Nickel / Copper', priceModifier: 0 },
      { label: 'Strawberry Bronze / Blush Pink', type: 'color', value: 'Strawberry Bronze', priceModifier: 2000 },
    ],
    emiPlans: [
      { tenureMonths: 3, interestRate: 0, processingFee: 0 },
      { tenureMonths: 6, interestRate: 0, processingFee: 0 },
      { tenureMonths: 9, interestRate: 12, processingFee: 199 },
      { tenureMonths: 12, interestRate: 13, processingFee: 299 },
    ],
  },
];
